...
* **Batch Processing:** Import unlimited journal names directly from Excel files for seamless background processing.
...
`Springer` • `Wiley` • `Elsevier` • `Emerald` • `Taylor & Francis` • `MDPI`

## 🛠️ Built With (Tech Stack)
* **Language:** Python
* **Interface Architecture:** PyQt6 UI/UX Engine
* **Core Frameworks:** Advanced Browser Automation, Data Extraction Pipelines, Vibe Coding
* **Deployment Packaging:** Standardized Windows Executable Build Pipeline
